...
export function DirectOtpModal({ phone, initialExpiresIn = 300, onClose }: DirectOtpModalProps) {
        ...
        >
            <div className="w-full max-w-md rounded-3xl bg-card p-6 md:p-8 shadow-2xl border border-border flex flex-col gap-6 relative">
                ...
                <div className="flex flex-col gap-2 text-center items-center">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">{t.directOtp.subtitle}</p>
                </div>
                ...
                {successMsg && (
                    <div
                        role="status"
                        aria-live="polite"
                        className="p-3 text-xs text-center rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 font-medium"
                    >
                        {successMsg}
                    </div>
                )}
