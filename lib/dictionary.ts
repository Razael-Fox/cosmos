...
const rawDictionary = {
  id: {
    ...
    howItWorks: {
      ...
      step1Desc: 'Daftarkan nomor Anda secara aman menggunakan form registrasi dengan perlindungan Cloudflare Turnstile.',
      step2Title: '2. Verifikasi Tanpa Risiko Banned',
      step2Desc: 'Kirim pesan .verify <TOKEN> dari WhatsApp Anda ke nomor bot resmi. WhatsApp mencatat interaksi sebagai obrolan organik.',
      step3Title: '3. Tautkan Sub-Bot & Whitelist Grup',
      step3Desc: 'Gunakan 8-digit Pairing Code atau scan QR untuk mengaktifkan sub-bot mandiri dan daftarkan JID grup yang ingin dikelola.',
    },
    features: {
  ...
  en: {
    ...
    howItWorks: {
      ...
      step2Desc: 'Send .verify <TOKEN> directly from your WhatsApp to our bot. WhatsApp recognizes it as genuine user-initiated chat.',
      step3Title: '3. Pair Sub-Bots & Whitelist Groups',
      step3Desc: 'Use the 8-digit Pairing Code or scan QR to activate your sub-bot and whitelist community groups.',
    },
    features: {
    ...
    dashboard: {
      ...
      confirmDeleteBotDesc: 'Are you sure you want to disconnect this sub-bot? Its WhatsApp connection session will be terminated.',
      ...
      subbotsCard: {
        ...
        noBotsDesc: 'Connect your personal WhatsApp number as an autonomous sub-bot using a pairing code or QR.',
        phoneCol: 'Bot Number',
        prefixCol: 'Prefix',
        statusCol: 'Status',
        createdCol: 'Created',
