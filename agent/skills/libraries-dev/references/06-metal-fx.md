...
<MetalFx ref={ref} preset="chromatic" variant="circle" innerShadow strength={0.9} reflectionTargets={[siblingRef]}>
...
export function Composer() {
    ...
    return (
        <div className="composer-bar">
            ...
            >
                <button type="button" aria-label="Send" style={{ width: 40, height: 40, borderRadius: 999 }}>
                    ↑
                </button>
            </MetalFx>
        </div>
...
<MetalFx preset="silver" strength={0.7}>
    <a
        href="/pricing"
        style={{ display: 'inline-flex', alignItems: 'center', height: 36, padding: '0 16px', borderRadius: 999 }}
    >
        Upgrade to Pro
    </a>
</MetalFx>
